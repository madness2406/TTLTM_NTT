...
public class BankUser extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtAmountToWithDraw, javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(txtAccIDtoWithDraw, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(btnDeposit, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(38, 38, 38))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(txtAmountToDeposit, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {
        try {
            ...
            m_bankManager = (BankManagerImpl) m_Registry.lookup("BankSystem");
    ...
    private void btnQrDatabaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQrDatabaseActionPerformed
        try {
            if (txtCustomerID.getText().length() > 0) {
                ...
                System.out.println("Hiện tại trong cơ sở dữ liệu có \n khách hàng này với ID : " + client.getName());
                txtCustomerID.setText("Hiện tại trong cơ sở dữ liệu có \n khách hàng này với ID: " + client.getName());
            } else {
                if (txtAccountID.getText().length() > 0) {
                    Account account = m_bankManager.getAccount(txtAccountID.getText());
                    txtAccountID.setText("");
                    System.out.println("Hiện tại trong cơ sở dữ liệu có \n tài khoản này với ID : " + account.getClient().getName());
    ...
    private void btnDepositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDepositActionPerformed
        ...
        try {
            if (txtAccIDtoDeposit.getText().length() > 0 && txtAmountToDeposit.getText().length() > 0) {
                ...
                txa_printArea.setText("Tài khoản này đã được  \n ghi lại " + account.getClient().getName() + "\nBalance:" + account.getBalance());
            }
        } catch (Exception ex) {
